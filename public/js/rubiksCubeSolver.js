...
{
    console.log("This is the whiteEdgeOnSides");
...
{
    console.log("This is the makeWhiteCross");
...
const setTwoWhiteCross = function (array, arrayCenter, centerColor)
{
    ...
    console.log("This is inside setTwoWhiteCross");
...
export const orientWhiteCross = function(array, arrayCenter)
{
    ...
    {        
        ...
        console.log("This is the whiteEdgeColor: ", initialColor); 
...
{
    console.log("This is makeSecondLayer"); 
...
const findOneRightYellowEdge = function(array, arrayCenter)
{
    ...
    for(let index = 0; index < PIECE_NUM; index++)
    {
        console.log(array[FRONT][POSITION_ZERO],"and ", array[FRONT][POSITION_ONE]);
